...
import type { HalaqahSelectorProps as HalaqahSelectorPropsType } from "@/features/setoran/types";

export function HalaqahSelector({
  halaqahNames,
  activeHalaqah,
  onHalaqahChange,
}: HalaqahSelectorPropsType) {
